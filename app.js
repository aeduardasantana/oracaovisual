...
const photoPools=[
 [],
 [pexels+'208216/pexels-photo-208216.jpeg?auto=compress&cs=tinysrgb&w=900',pexels+'1477595/pexels-photo-1477595.jpeg?auto=compress&cs=tinysrgb&w=900',pexels+'3225889/pexels-photo-3225889.jpeg?auto=compress&cs=tinysrgb&w=900',pexels+'257037/pexels-photo-257037.jpeg?auto=compress&cs=tinysrgb&w=900'],
 [pexels+'568027/pexels-photo-568027.jpeg?auto=compress&cs=tinysrgb&w=900',pexels+'3768131/pexels-photo-3768131.jpeg?auto=compress&cs=tinysrgb&w=900',pexels+'3807738/pexels-photo-3807738.jpeg?auto=compress&cs=tinysrgb&w=900',pexels+'236151/pexels-photo-236151.jpeg?auto=compress&cs=tinysrgb&w=900'],
 [pexels+'1128318/pexels-photo-1128318.jpeg?auto=compress&cs=tinysrgb&w=900',pexels+'461198/pexels-photo-461198.jpeg?auto=compress&cs=tinysrgb&w=900',pexels+'3184465/pexels-photo-3184465.jpeg?auto=compress&cs=tinysrgb&w=900',pexels+'1022923/pexels-photo-1022923.jpeg?auto=compress&cs=tinysrgb&w=900'],
 [pexels+'1477595/pexels-photo-1477595.jpeg?auto=compress&cs=tinysrgb&w=900',pexels+'1022923/pexels-photo-1022923.jpeg?auto=compress&cs=tinysrgb&w=900',pexels+'6646918/pexels-photo-6646918.jpeg?auto=compress&cs=tinysrgb&w=900',pexels+'3768131/pexels-photo-3768131.jpeg?auto=compress&cs=tinysrgb&w=900'],
 [pexels+'1128318/pexels-photo-1128318.jpeg?auto=compress&cs=tinysrgb&w=900',pexels+'6646918/pexels-photo-6646918.jpeg?auto=compress&cs=tinysrgb&w=900',pexels+'7551670/pexels-photo-7551670.jpeg?auto=compress&cs=tinysrgb&w=900',pexels+'208216/pexels-photo-208216.jpeg?auto=compress&cs=tinysrgb&w=900'],
 [pexels+'208216/pexels-photo-208216.jpeg?auto=compress&cs=tinysrgb&w=900',pexels+'1477595/pexels-photo-1477595.jpeg?auto=compress&cs=tinysrgb&w=900',pexels+'268533/pexels-photo-268533.jpeg?auto=compress&cs=tinysrgb&w=900'],
 [pexels+'6646918/pexels-photo-6646918.jpeg?auto=compress&cs=tinysrgb&w=900',pexels+'3184465/pexels-photo-3184465.jpeg?auto=compress&cs=tinysrgb&w=900',pexels+'3768131/pexels-photo-3768131.jpeg?auto=compress&cs=tinysrgb&w=900',pexels+'3225889/pexels-photo-3225889.jpeg?auto=compress&cs=tinysrgb&w=900']
];
...
function render(){
 ...
 content.innerHTML=`<div class="step-head"><span class="step-number">${step.purpose} · PASSO ${current+1} DE ${steps.length}</span><h2>${step.title}</h2><p>${step.subtitle}</p></div><div class="cards">${step.items.map((item,index)=>{const image=photoPools[current][index%Math.max(photoPools[current].length,1)]||'';return `<button type="button" class="visual-card ${step.type||''} ${step.fixed?'fixed':''} ${choices[current].includes(item.id)?'selected':''}" data-id="${item.id}" style="--pos:${item.pos||'50% 50%'};--image:url('${image}')" aria-pressed="${choices[current].includes(item.id)}"><span class="check">✓</span><span class="art" role="img" aria-label="${item.label}"></span><span class="label">${item.label}</span><span class="meaning">${item.meaning}</span><span class="image-credit">${current===0?'Ilustração original':'Imagem: Pexels'}</span></button>`}).join('')}</div>${step.saintField?`<div class="saint-field"><label for="saintName">OUTRO SANTO DE DEVOÇÃO</label><input id="saintName" maxlength="60" value="${saintName}" placeholder="Exemplo: Santa Teresinha do Menino Jesus"><small>O nome será usado apenas nesta oração.</small></div>`:''}`;
