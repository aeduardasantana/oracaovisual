const CACHE='oracao-visual-v3';
const FILES=['./','./index.html','./styles.css?v=20260916-5','./oracoes-ilustradas.css?v=20260917-7','./app.js?v=20260917-1','./manifest.webmanifest?v=20260916-1','./assets/app-icon.svg','./assets/oracao-visual-hero.webp','./assets/trindade/santissima-trindade.svg?v=20260916-3'];
