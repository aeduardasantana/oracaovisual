const CACHE='oracao-visual-v1';
const FILES=['./','./index.html','./styles.css?v=20260916-2','./app.js?v=20260916-4','./manifest.webmanifest?v=20260916-1','./assets/app-icon.svg','./assets/oracao-visual-hero.webp','./assets/trindade/santissima-trindade.svg?v=20260916-3'];
